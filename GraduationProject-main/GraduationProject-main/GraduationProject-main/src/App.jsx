...
function App() {
  ...
  const [alpha, setAlpha] = useState(""); // default value of 0.05 for alpha
  const [populationMean, setPopulationMean] = useState(""); // default value for population mean
  const [alternative, setAlternative] = useState(""); // default value for alternative hypothesis
